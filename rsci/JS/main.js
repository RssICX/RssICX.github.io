...
var bd=["0","原千惠","黄罄悦","贾金元","马研博","王子宁","颜家辉","王子煜","毋羽墨","董娜伶","郭治瑞","黄薯悦","刘佳琪","屈弛越","田乐熙","姬婧涵","花子雯","赵睿健","冯思尧","李慧慧","刘轩颖","任丽媛","刘岳","刘炎汶","侯金妍","徐最睿","王耀萱","王怡萱","陈浩川","丁子悦","孙彦筠","高欣苒","朱振华","牛佳易","颜家兴","刘旭翔","李浩宇","秦子墨","李承志","李少博","高嘉悦","胡馨月","路吴霖","史涵祺","程昱歌","姬瑞甜","袁旖聪","陈炳宇","姬琉源","任悠然","赵亦凡","谷皓宇","范凌薇","李骁航","梁羽涵","郭鹏飞"],i = 0, u = 0, tyu = 0;
